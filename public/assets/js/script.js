...
const handleAnimalFormSubmit = event => {
  ...
  // fetch request to post the added animal. first define the type of request method (POST). Next, tell the application what type of data is being sent (JSON) so we can add stringified JSON data for our animalObject to the body property of the request. 
  fetch('/api/animals', {
    method: 'POST',
    headers: {
